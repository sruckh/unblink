...
export default function ArkSwitch(props: {
    ...
    >
        <Switch.Control class="relative inline-flex h-6 w-11 items-center rounded-full border-2 border-transparent transition-colors focus:outline-none data-[state=checked]:bg-violet-600 data-[state=unchecked]:bg-neu-700">
